...
public class TextReader {
	...
	private static final Logger logger = LogFactory.getLogger(TextReader.class);

	private static final int imageType = BufferedImage.TYPE_INT_ARGB;

	public static final String alpha = "0123456789abcdefghijklmnopqrstuvwxyz&é#'{([-|è_\\çà@)°])+=}$%ùµ*!§:/;.,?<>²ê£".toLowerCase();
	...
	public String read() {
		...
		for (BufferedImage line : lines) {
			...
			result += lineText + TrayPassObject.lineSeparator;
		}
		return result;
	}
